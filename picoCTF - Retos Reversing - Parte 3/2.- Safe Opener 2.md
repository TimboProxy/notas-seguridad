...
SafeOpener.class
cerq-picoctf@webshell:~$ javap -c SafeOpener.class 
...
Aquí en este reto tenemos que guiarnos en la pista que nos dice que intentemos decompilar el archivo, el archivo que nos descarga es un .class y para descompilarlo sería el siguiente comando:
javap -c nombredelarchivo

la bandera es: picoCTF{SAf3_0p3n3rr_y0u_solv3d_it_3dae8463} que la encontramos leyendo el codigo
