...
## Solución 
Al conectarnos a ese puerto obtenemos el siguiente mensaje:
...
Podemos ver que es la encriptación de Viegenere, pero no conocemos la contraseña, por lo cual necesitamos una herramienta que nos haga hacer un ataque de fuerza bruta para obtenerlo, al hacerlo obtenemos lo siguiente:
